                                ...
                                <form action="{{ route('produk.store') }}" method="post">
									...
									<div class="row row-xs align-items-center mg-b-20">
										...
										<div class="col-md-8 mg-t-5 mg-md-t-0">
											<input class="form-control" placeholder="Enter your nama produk" name="nama produk" type="integer">
										</div>
									</div>
									<div class="row row-xs align-items-center mg-b-20">
										<div class="col-md-4">
									...
									<a href="{{ route('produk.index') }}" method="post" class="btn btn-dark pd-x-30 mg-t-5"> << KEMBALI </a>
                                </form>
								</div>
							</div>
						</div>
