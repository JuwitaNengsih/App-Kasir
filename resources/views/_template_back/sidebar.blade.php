    ...
    <aside class="app-sidebar sidebar-scroll">
        ...
        <div class="main-sidemenu">
                ...
                <div class="app-sidebar__user">
                    <div class="dropdown user-pro-body text-center">
                        ...
                        <div class="user-info">
                            ...
                            <!-- MENAMPILAN NAMA LENGKAP YANG LOGIN -->
                            <span class="text-muted app-sidebar__user-name text-sm">Administrator</span>
                            <!-- MENAMPILKAN ROLE YANG LOGIN -->
                        </div>
                    </div>
                </div>
            </div>
            ...
            <ul class="side-menu ">
                ...
                <li class="slide">
                    <a class="side-menu__item {{ request()->is('') ? 'active' : '' }}" href="{{ route('detail penjualan.index') }}"><i class="side-menu__icon si si-notebook"></i><span class="side-menu__label">Detail Penjualan</span></a>
                </li>
